...
describe('src/handlers/v1', () => {
  ...
  describe('update queue', () => {
    it('updates the queue metadata', () => {
      ...
      // Act / Assert
      return supertest(app)
        .post('/v1/queue/orid:1:mdsCloud:::1:qs:test')
    ...
    it('returns bad request when queue is not orid', () => {
      // Arrange
      const app = src.buildApp();
  ...
  describe('delete queue', () => {
    it('removes the queue when it exists', () => {
      ...
      // Act / Assert
      return supertest(app)
        .delete('/v1/queue/orid:1:mdsCloud:::1:qs:test')
        .expect(204)
        .then(() => {
  ...
  describe('get queue details', () => {
    it('returns queue details when queue exists without metadata', () => {
      ...
      // Act / Assert
      return supertest(app)
        .get('/v1/queue/orid:1:mdsCloud:::1:qs:test/details')
        .expect(200, {
  ...
  describe('get message count for queue', () => {
    it('returns when queue exists', () => {
      ...
      // Act / Assert
      return supertest(app)
        .get('/v1/queue/orid:1:mdsCloud:::1:qs:test/length')
        .expect(200, {
          size: 11,
          orid: 'orid:1:mdsCloud:::1:qs:test',
        });
    ...
    it('returns 404 when queue does not exist', () => {
      ...
      // Act / Assert
      return supertest(app)
        .get('/v1/queue/orid:1:mdsCloud:::1:qs:test3/length')
        .expect(404);
    });
  ...
  describe('get message from queue', () => {
    it('returns when queue exists', () => {
      ...
      // Act / Assert
      return supertest(app)
        .get('/v1/queue/orid:1:mdsCloud:::1:qs:test/message')
        .expect(200, { id: 1 });
    });
  ...
  describe('create message in queue', () => {
    it('successful when queue exists', () => {
      ...
      // Act / Assert
      return supertest(app)
        .post('/v1/queue/orid:1:mdsCloud:::1:qs:test/message')
  ...
  describe('remove message from queue', () => {
    it('successful when message exists', () => {
      ...
      // Act / Assert
      return supertest(app)
        .delete('/v1/queue/orid:1:mdsCloud:::1:qs:test/message/123')
        .expect(200);
    });
    ...
    it('returns bad request when queue is not orid', () => {
      ...
      // Act / Assert
      return supertest(app)
        .delete('/v1/queue/test/message/test')
        .expect(400);
    });
  });
});
